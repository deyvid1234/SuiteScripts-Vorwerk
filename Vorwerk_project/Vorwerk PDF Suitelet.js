...
define(['N/runtime','N/email','N/record','N/render', 'N/search','N/xml','N/config','N/file','N/url','./Vorwerk Utils.js','./Vorwerk Dictionary Script.js'],
    function(runtime,email,record,render,search,xml,config,file,url,Utils,Dictionary) {
		...
		//configuracion presentadora
			...
			var bono32 = data.bono_m_4
			var bono52 = data.bono_m_5
			var bonosc = data.bono_m_6
...
//							log.debug('ODV encontrada en ck')
			...
			if (type_emp == 3){
				...
				strTable += "<tr>";
				strTable += "<td border='0.5' colspan= '4' border-style='none' align='right'><b>Numero de Ventas de Equipo</b></td>";
				...
				strTable += "</tr>";
				strTable += "<tr>";
				strTable += "<td border='0.5' colspan= '4' border-style='none' align='right'><b>Supercomision</b></td>";
