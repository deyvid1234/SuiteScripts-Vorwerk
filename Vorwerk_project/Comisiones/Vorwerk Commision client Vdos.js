...
function(record,https,currentRecord,runtime,file,search,message) {
            ...
            for (var i = 0; i < listLineCount; i++) {
                ...
                if(check == true){
                   ...
                   var ventas_propias_ids = record.getSublistValue({
                    ...
                    var lider_nle = record.getSublistValue({
                        sublistId: "sublist",
                        fieldId: "custentity_lider_nle",
                        line: i
                    });
                    var nle_monto = record.getSublistValue({
                        sublistId: "sublist",
                        fieldId: "custentity_nle_monto",
                        line: i
                    });
                    
                    var xmasdos_nle = record.getSublistValue({
                        sublistId: "sublist",
                        fieldId: "custentity_xmasdos_nle",
                        line: i
                    });
                    var tresmasdos_nle_monto = record.getSublistValue({
                        sublistId: "sublist",
                        fieldId: "custentity_tresmasdos_nle_monto",
                        line: i
                    });
                    var cincomasdos_nle_monto = record.getSublistValue({
                        sublistId: "sublist",
                    ...
                    object_fill.push({
                            ...
                            lider_nle             :lider_nle,
                            nle_monto             :nle_monto,
                            xmasdos_nle           :xmasdos_nle,
                            tresmasdos_nle_monto  :tresmasdos_nle_monto,
                            cincomasdos_nle_monto :cincomasdos_nle_monto,
                            total                 :total,
                            tm_pagada             :tm_pagada,
    ...
    function createExcel(){
        try{
                ...
                var url = '';
                if(runtime.envType != 'PRODUCTION'){ 
                    url = 'https://3367613-sb1.app.netsuite.com/app/site/hosting/scriptlet.nl?script=1497&deploy=1';
                }else{
