define(['N/record', 'N/search','N/runtime','N/format','N/query','./Vorwerk Dictionary Script.js'],

function(record, search, runtime, format, query,Dictionary) {
        ...
        getSearchFiltersSO: function(objData,objPeriod,tm_pagada,historico,h_ingreso){
            ...
            if (historico){
                if(h_ingreso == true){
                    ...
                    var H_start = this.getObjPeriod(8);
                    var H_end = this.getObjPeriod(id_period-1);
                    var start = H_start['startDate']
                    var end = H_end['endDate']
            ...
            log.debug('Arr return Utils',arrReturn);
            return arrReturn;
        },
