...
//                     manual_bond : !r.getValue('custrecord_c_jdg_total_bono_manual')?0:r.getValue('custrecord_c_jdg_total_bono_manual'),
                     ...
                     estatusTimbrado:!r.getValue('custrecord_estatus_timbrado')?'':r.getValue('custrecord_estatus_timbrado'),
...
//                     manual_bond : !r.getValue('custrecord_c_pre_total_bono_manual')?0:r.getValue('custrecord_c_pre_total_bono_manual'),
                     ...
                     estatusTimbrado:!r.getValue('custrecord_estatus_timbrado_pre')?'':r.getValue('custrecord_estatus_timbrado_pre'),
...
//                     manual_bond :0,
                     ...
                     estatusTimbrado:!r.getValue('custrecord_estatus_timbrado_gtm')?'':r.getValue('custrecord_estatus_timbrado_gtm'),
