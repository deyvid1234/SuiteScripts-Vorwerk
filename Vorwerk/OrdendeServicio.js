...
function OrdendeServicioPDF(request, response)
{
	...
	try
	{
		...
		var nombre 		= nlapiEscapeXML(returnBlank(customer.getFieldValue('altname')));
		...
		var modelo		= returnBlank(record.getFieldValue('custbody_modelo_eq'));
        if (modelo == 1) {modelo = 'TM5'}
        if (modelo == 2) {modelo = 'TM31'}
        if (modelo == 3) {modelo = 'Otro'}
      	if (modelo == 4) {modelo = 'TM6'}
		...
		var Encabezado = '';
			Encabezado += "<table width='100%'>";
				...
				Encabezado += "</tr>";
				Encabezado += "<tr>";
					Encabezado += "<td colspan='26' align='center' font-size=\"6pt\">" + "Vorwerk México, S. de R.L. de C.V." + "</td>"; //INFORMACION DE LA EMPRESA
				Encabezado += "</tr>";
				Encabezado += "<tr>";
					Encabezado += "<td colspan='26' align='center' font-size=\"6pt\">" + "Vito Alessio Robles 38 Col. Florida, Del. Álvaro Obregón" + "</td>";
				Encabezado += "</tr>";
				Encabezado += "<tr>";
					Encabezado += "<td colspan='26' align='center' font-size=\"6pt\">" + "Cd. de México, C.P.01030 Teléfono: 5616 5560" + "</td>";
				Encabezado += "</tr>";
				Encabezado += "<tr>";
		...
		var strName = ''; //CUERPO
			...
			condordserv	= '<tr><td>La firma de éste documento implica la aceptación de todas y cada una de las siguientes condiciones:</td></tr>'+
				...
				'técnicos necesarios que determinen la falla o avería en el equipo Thermomix '+modelo+' con número de serie '+serie+'.</td></tr>'+
				...
				'<tr><td>3) Vorwerk México S. de R.L. de C.V. se compromete a notificar al cliente el diagnóstico realizado al equipo Thermomix '+modelo+' que se deje para valoración '+
				...
				'Thermomix '+modelo+' con número de serie. '+serie+' será destruido sin que exista ninguna responsabilidad para Vorwerk México, S. de R.L. de C.V.</td></tr>'+
			...
			var condordserv2 = '<tr><td>Para el caso de que la entrega sea dentro de la demarcación de la Ciudad de México, el costo será de $350.00 (TRESCIENTOS CINCUENTA PESOS 00/100 M.N.)'+
								...
								'<tr><td>14) Si requieres factura deberás proporcionar tu constancia de situación fiscal al momento de realizar tu pago, si es por transferencia lo deberás enviar por correo.</td></tr>';
