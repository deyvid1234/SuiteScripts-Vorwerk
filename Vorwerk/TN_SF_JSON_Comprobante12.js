			...
			if(customsearch_tn_sf_xml_comprobante != '')
			{
				...
				{		
	        		...
	        		var Comprobante 										= new Object();
		        		...
		        		Comprobante.LugarExpedicion 						= companyInfoZip; //companyInfoCity + ', ' + companyInfoState + ', ' + companyInfoCountry + ', ' + companyInfoZip +  ', ' + companyInfoFax + ' / ' + companyInfoPhone;
		        		Comprobante.NumCtaPago								= ultimosDigitos;
		        		Comprobante.metodoDePago 							= 'NA'; //'Transferencia Electrónica';
		        		Comprobante.TipoCambio 								= 1.0;
		        		Comprobante.Moneda 									= 'MXN';
		        		Comprobante.fecha 									= stringDateTimeSF(nlapiDateToString(new Date()));
		        		Comprobante.formaDePago 							= 'En una sola exhibición';
		        		Comprobante.sello 									= '';
		        		...
		        		Comprobante.Emisor.RegimenFiscal.push({Regimen:returnBlank(customsearch_tn_sf_xml_comprobante[0].getText('custentity_c_nom_regimenfiscal',join))});
	        			...
	        			Comprobante.Complemento.Nomina.Version						= 1.2;
	        			Comprobante.Complemento.Nomina.NumEmpleado					= 1.2;
	        			Comprobante.Complemento.Nomina.CURP							= 1.2;
	        			Comprobante.Complemento.Nomina.NumSeguridadSocial			= 1.2;
	        			Comprobante.Complemento.Nomina.FechaPago					= 1.2;
	        			Comprobante.Complemento.Nomina.FechaInicialPago				= 1.2;
	        			Comprobante.Complemento.Nomina.FechaFinalPago				= 1.2;
	        			Comprobante.Complemento.Nomina.NumDiasPagados				= 1.2;
	        			Comprobante.Complemento.Nomina.FechaInicioRelLaboral		= 1.2;
	        			Comprobante.Complemento.Nomina.PeriocidadPago				= 1.2;
