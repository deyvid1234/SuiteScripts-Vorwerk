function Orden_Venta_Btn(type, form, request)
{
	...
	try
	{
		if(type == 'view')
		{
			var titleForm		= 'Imp. Orden de Venta';
	    	...
	    	var url 			= nlapiResolveURL("SUITELET", "customscript_orden_venta_pdf", "customdeploy_orden_venta_pdf", false);
				url 	   		+= "&data=" 	+ data;
	...
	catch(e)
	{
		...
		var context				= nlapiGetContext();		
	  	...
	  	var author				= -5;
	  	var recipient			= 'sponce@imr.com.mx';
	  	var subject				= '';
	  	var body 				= '';
  			body 			   += '<table>';
