function Orden_Compra_PDF(request, response) {
    ...
    try {
        ...
        Encabezado += "<tr>";
        Encabezado += "<td align='left'><img width=\"120%\" height=\"120%\" " + companyInfoLogoURL + "></td>";
        Encabezado += "<td align='right' font-size=\"14pt\"><b>ORDEN DE COMPRA</b></td>";
        Encabezado += "</tr>";
        Encabezado += "</table>";
        ...
        Encabezado2 += "<tr>";
        Encabezado2 += "<td align='right'><img width=\"120%\" height=\"120%\" " + companyInfoLogoURL + "></td>";
        Encabezado2 += "</tr>";
        Encabezado2 += "</table>";
        ...
        Pie += "<table width='100%'>";
        Pie += "<tr>";
        Pie += "<td width='50%' rowspan='3'><img width=\"80%\" height=\"80%\" " + thermomixURL + "></td>";
        Pie += "<td width='50%' align='right' font-size=\"6pt\">" + companyInfoName + "</td>";
        Pie += "</tr>";
        Pie += "<tr>";
        Pie += "<td width='50%' align='right' font-size=\"6pt\">" + companyAddress + "</td>";
        Pie += "</tr>";
        Pie += "<tr>";
        Pie += "<td width='50%' align='right' font-size=\"6pt\">RFC: " + companyInfoRFC + "</td>";
        Pie += "</tr>";
        Pie += "</table>";
        ...
        xml += "</macrolist>";
        xml += "</head>";
        xml += "<body font-family='OpenSansRegular' font-size='7' size='letter'  header=\"myheader\" header-height=\"60pt\" footer=\"paginas\" footer-height='80pt'>";
        xml += strName;
        xml += "</body>\n";
        xml += "</pdf>";
        ...
        xml += "</macrolist>";
        xml += "</head>";
        xml += "<body font-family='OpenSansRegular' font-size='7' header=\"myheader1\" header-height=\"60pt\" footer=\"nlfooter\" footer-height=\"20pt\" padding=\"0.5in 0.5in 0.5in 0.5in\" size=\"Letter\" >\n" +
            "    &nbsp;\n"
        ...
        xml += "</macrolist>";
        xml += "</head>";
        xml += "<body font-family='OpenSansRegular' font-size='7' header=\"myheader2\" header-height=\"60pt\" footer=\"paginas\" footer-height='80pt' padding=\"0.5in 0.5in 0.5in 0.5in\" size=\"Letter\">\n"
        ...
        xml += "</macrolist>";
        xml += "</head>";
        xml += "<body font-family='OpenSansRegular' font-size='7' header=\"myheader3\" header-height=\"60pt\" footer=\"nlfooter\" footer-height=\"20pt\" padding=\"0.5in 0.5in 0.5in 0.5in\" size=\"Letter\">\n";
