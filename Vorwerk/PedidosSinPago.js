	...
	try
	{
		if(type != 'delete')
		{
			...
			var filters			= new Array();
				filters.push(new nlobjSearchFilter('custbody_mp_orden_venta_relacionada', null, 'is', recordId));
				filters.push(new nlobjSearchFilter('mainline', null, 'is', 'T'));
			var searchResults 	= returnBlank(nlapiSearchRecord('customerpayment', null, filters, null));
			if(searchResults == '')
			{
			    ...
			    var url			= nlapiResolveURL('RECORD', recordType, recordId, false);
